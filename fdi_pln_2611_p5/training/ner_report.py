...
<div class="summary">
  <strong>Mejor epoch:</strong> {best_epoch} &nbsp;|&nbsp;
  <strong>Mejor val_loss:</strong> {_fmt(best_row.get("val_loss", 0))} &nbsp;|&nbsp;
  <strong>Accuracy:</strong> {_pct(best_row.get("overall_acc", 0))} &nbsp;|&nbsp;
  <strong>Entity Recall:</strong> {_pct(best_row.get("entity_recall", 0))}
</div>
