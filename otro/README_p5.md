...
| `run-experiments` | 8 experimentos (corpus, ventana, vocab, profundidad) + informe HTML |
| `experiment-report` | Regenera `informe_experimentos.html` desde el JSON |
...
# Exploración para memoria (8 experimentos: corpus, ventana, vocab, profundidad; curvas en HTML)
uv run fdi-pln-2611-p5 run-experiments
# → data/experiment_results.json, data/informe_experimentos.html
# → data/experiments/<id>/model.pth, experiment_config.json, bpe_tokenizer.json
